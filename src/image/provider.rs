...
impl Provider {
    ...
    pub async fn load_into_image(
        ...
        match pixbuf {
            Some(ImageContents::Paintable(paintable)) => image.set_paintable(Some(&paintable)),
...
//         Self {
//             desktop_files,
//             icon_theme: RefCell::new(IconTheme::default()),
//             overrides: overrides_map,
//             cache: arc_mut!(Cache::new()),
//         }
//     }
...
//                 input_name.chars().skip("steam_app_".len()).collect(),
//             )),
//             None if self.icon_theme().has_icon(input) => {
//                 Some(ImageLocation::Icon(input_name.to_string()))
//             }
//             Some(input_type) => {
//                 warn!(
