...
| `popup.grow_height_until`     | `integer` | `250`                                                 | Grows the Height of the Popup automatically based on the content up to this limit in pixel. Usefull when scrolling is enabled.                   |
